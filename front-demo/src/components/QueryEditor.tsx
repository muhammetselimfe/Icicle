...
function QueryEditor({ initialQuery, title, description, onQueryChange }: QueryEditorProps) {
            ...
            <div className="bg-white rounded-lg shadow p-6 space-y-4">
                <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        className="w-full h-64 px-4 py-3 font-mono text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-y"
